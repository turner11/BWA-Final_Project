...
//
    ...
    public partial  class ChartForm : Form
    {
        ...
        /// <param name="isInvisibleLegend"> Gets or sets a flag that indicates whether the item is shown in the legend.</param>
        ...
        public Series AddSeries(string name, bool isInvisibleLegend, bool isXvalueIndexed, SeriesChartType chartType)
        {
            ...
            var series = new System.Windows.Forms.DataVisualization.Charting.Series
            {
                ...
                IsVisibleInLegend = isInvisibleLegend,
